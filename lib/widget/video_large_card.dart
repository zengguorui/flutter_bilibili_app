        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Text(durationTransform(videoModel.duration), style: TextStyle(color: Colors.white, fontSize: 10),),
          ),),
        ],
      ),
    );
    ...
    return Row(
      children: [
        Container(
          ...
          child: Text("UP", style: TextStyle(fontSize: 8, color: Colors.grey, fontWeight: FontWeight.bold)),
        ),
        hiSpace(width: 8),
